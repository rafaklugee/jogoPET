...
function Button (text, func, func_param, width, heigth)
    return {
        ...
        func = func or function ()
            print ("Esse botão ainda não tem uma função!")
        end,
        ...
        draw = function (self, button_x, button_y, text_x, text_y)
            ...
            if text_x then --se existe text_x...
                self.text_x = text_x + self.button_x
            else
                self.text.x = self.button_x
            end

            if text_y then --se existe text_x...
                self.text_y = text_y + self.button_y
            else
                self.text.y = self.button_y
            end
